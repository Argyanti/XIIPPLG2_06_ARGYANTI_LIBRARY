...
router.post("/", async (req, res) => {
    try {
    const { books_id, user_id, loan_date, return_date, status } = req.body;
    ...
    const loanId = await Loans.addLoan({ books_id, user_id, loan_date, return_date, status });
...
router.put("/:id", async (req, res) => {
    ...
    const updated = await Loans.updateLoan(Number(id), { books_id, user_id, loan_date, return_date, status });
